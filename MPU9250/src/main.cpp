...
void setup() {
	...
	pinMode(LED, OUTPUT);  //set pin direction
	digitalWrite(LED, HIGH);

	SPI.begin(); // we have not defined pins
...
void loop() {
	...
	Serial.print(mpu.gyro_data[0]);   Serial.print('\t');//x
	Serial.print(mpu.gyro_data[1]);   Serial.print('\t');//y
	Serial.print(mpu.gyro_data[2]);   Serial.print('\t');//z axis
